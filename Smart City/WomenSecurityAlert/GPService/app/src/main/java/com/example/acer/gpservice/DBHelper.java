...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String TABLE_NAME="saved_reacording_table";
    ...
    private static final String SQLITE_CREATE_TABLE="CREATE TABLE IF NOT EXISTS "+TABLE_NAME+"(id INTEGER PRIMARY KEY AUTOINCREMENT,"
